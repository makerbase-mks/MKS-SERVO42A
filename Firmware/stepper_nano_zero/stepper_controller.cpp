...
void StepperCtrl::updateParamsFromNVM(void)
{
	...
	} else
	{
		...
		motorParams.currentHoldMa=100;	//500
		motorParams.currentMa=300;		//1500
		motorParams.homeHoldMa=100;		//200
		motorParams.homeMa=300;			//800
...
#ifndef MKS_USE_AS	//mks mark ("USE_AS")
