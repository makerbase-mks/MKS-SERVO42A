...
extern  void setDAC(uint32_t DAC1, uint32_t DAC2);
uint32_t	led_cnt = 0;
void stepperTest()
{
	setupDAC();
	...
	while(1)
	{
		gpio_set_pin_level(IN2,	true);
		gpio_set_pin_level(IN1,	false);
		gpio_set_pin_level(IN3,	false);
		gpio_set_pin_level(IN4,	true);
		delay(50);

		gpio_set_pin_level(IN2,	true);
		gpio_set_pin_level(IN1,	false);
		gpio_set_pin_level(IN3,	true);
		gpio_set_pin_level(IN4,	false);
		delay(300);
