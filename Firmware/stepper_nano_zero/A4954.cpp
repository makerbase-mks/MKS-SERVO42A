...
static inline void bridge1(int state)
{
	...
	/*
		...
		gpio_set_pin_level(IN1,	true);
		gpio_set_pin_level(IN2,	false);
	*/
		PORT->Group[PORTA].PINCFG[0x05].bit.PMUXEN = 0; 			//PIN_A4954_IN1
		((Port *)0x60000000)->Group[0x00].OUTSET.reg = 0x00000020;	//IN1 true
		((Port *)0x60000000)->Group[0x00].OUTCLR.reg = 0x00200000;	//IN2 false

		pinState=(pinState & 0x0C) | 0x1;
	}
	if (state==1)
	{
		PORT->Group[PORTA].PINCFG[0x15].bit.PMUXEN = 0;				//PIN_A4954_IN2
		((Port *)0x60000000)->Group[0x00].OUTCLR.reg = 0x00000020;	//IN1 false
		((Port *)0x60000000)->Group[0x00].OUTSET.reg = 0x00200000;	//IN2 true
...
static inline void bridge2(int state)
{
	if (state==0)
	{
		PORT->Group[PORTA].PINCFG[0x0f].bit.PMUXEN = 0;				//PIN_A4954_IN3
		((Port *)0x60000000)->Group[0x00].OUTSET.reg = 0x00008000;	//IN3 true
		((Port *)0x60000000)->Group[0x00].OUTCLR.reg = 0x00100000;	//IN 4false
		pinState=(pinState & 0x03) | 0x4;
	}
	if (state==1)
	{
		PORT->Group[PORTA].PINCFG[0x14].bit.PMUXEN = 0;				//PIN_A4954_IN4
		((Port *)0x60000000)->Group[0x00].OUTCLR.reg = 0x00008000;	//IN3 false
		((Port *)0x60000000)->Group[0x00].OUTSET.reg = 0x00100000;	//IN4 true
